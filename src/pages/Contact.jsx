        ...
        <div className="space-y-8">
          ...
          <div className="pt-2">
            ...
            <div className="flex gap-4 text-xl">
              <a href="https://instagram.com/hannah_patisserie_gh/" target="_blank" rel="noopener noreferrer" className="text-rose-dark hover:text-rose transition focus:outline-none focus:ring-2 focus:ring-rose rounded p-2" aria-label="Follow us on Instagram"><i className="fab fa-instagram" aria-hidden="true"></i></a>
              <a href="https://facebook.com/p/hannah_patisserie_gh" target="_blank" rel="noopener noreferrer" className="text-rose-dark hover:text-rose transition focus:outline-none focus:ring-2 focus:ring-rose rounded p-2" aria-label="Like us on Facebook"><i className="fab fa-facebook" aria-hidden="true"></i></a>
